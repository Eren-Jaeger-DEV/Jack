...
gcloud compute ssh jack-bot-vm --zone=asia-south2-a --command "sudo su - gahlautanshuman384 -c 'cd Jack && git pull origin main && chmod +x scripts/deploy.sh && ./scripts/deploy.sh'"
